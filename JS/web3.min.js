require = (function t(e, n, r) {
    ...
    for (
        var i = "function" == typeof require && require, a = 0; a < r.length; a++
    )
        o(r[a]);
    return o;
})({
            ...
            (i.prototype.decode = function(t, e, n) {
                ...
                if (this.isDynamicType(n))
                    return (function() {
                        ...
                        return r._outputFormatter(
                            new o(t.substr(2 * n, 64 * (1 + a)), 0)
                        );
                    })();
    ...
    22: [
        function(t, e, n) {
            function r(t) {
                ...
                (this.settings = new p()),
                (this.version = { api: l.version }),
                (this.providers = { HttpProvider: v, IpcProvider: b }),
                (this._extend = m(this)),
                this._extend({ properties: w() });
            }
            var o = t("./web3/requestmanager"),
                ...
                _ = t("bignumber.js");
            (r.providers = { HttpProvider: v, IpcProvider: b }),
            ...
            (r.prototype.BigNumber = _),
            (r.prototype.toHex = h.toHex),
            (r.prototype.toAscii = h.toAscii),
            (r.prototype.toUtf8 = h.toUtf8),
            (r.prototype.fromAscii = h.fromAscii),
            (r.prototype.fromUtf8 = h.fromUtf8),
            (r.prototype.toDecimal = h.toDecimal),
            (r.prototype.fromDecimal = h.fromDecimal),
            (r.prototype.toBigNumber = h.toBigNumber),
            (r.prototype.toWei = h.toWei),
            (r.prototype.fromWei = h.fromWei),
            (r.prototype.isAddress = h.isAddress),
            (r.prototype.isChecksumAddress = h.isChecksumAddress),
            (r.prototype.toChecksumAddress = h.toChecksumAddress),
            (r.prototype.isIBAN = h.isIBAN),
            ...
            var r = t("../utils/utils"),
                                        ...
                                        function(n, i) {
                                            i &&
                                                ...
                                                t._eth.getCode(i.contractAddress, function(n, a) {
                                                    if (!r && a)
                                                        if ((o.stopWatching(), (r = !0), a.length > 3))
                ...
                l = function(t, e) {
                    ...
                    (this.new = function() {
                        ...
                        var a = c(this.abi, o);
                        if (((n.data += a), t))
                            this.eth.sendTransaction(n, function(n, r) {
        ...
        function(t, e, n) {
            var r = t("./formatters"),
                ...
                c = function(t) {
                    ...
                    t.requestManager.startPolling({ method: t.implementation.poll.call, params: [t.filterId] },
                        t.filterId,
                        e,
                    ...
                    return (
                        ...
                        this.implementation.newFilter(this.options, function(t, e) {
                            if (t)
                                ...
                                ((i.filterId = e),
                                    i.getLogsCallbacks.forEach(function(t) {
                                        i.get(t);
                                    }),
                                    (i.getLogsCallbacks = []),
            ...
            var r = t("../utils/utils"),
                ...
                f = function(t) {
                    return (
                        ...
                        t.to && (t.to = v(t.to)), ["gasPrice", "gas", "value", "nonce"]
                        .filter(function(e) {
                            return void 0 !== t[e];
                        })
                        .forEach(function(e) {
        ...
        function(t, e, n) {
            ...
            (s.prototype.extractDefaultBlock = function(t) {
                if (
                    ...
                    return i.inputDefaultBlockNumberFormatter(t.pop());
            }),
    ...
    32: [
        function(t, e, n) {
            ...
            (a.prototype.prepareRequest = function(t) {
                var e;
                return (
                    t ? ((e = new i()), (e.timeout = this.timeout)) : (e = new r()),
    ...
    34: [
        function(t, e, n) {
            ...
            (i.prototype.isConnected = function() {
                var t = this;
                return (
                    t.connection.writable || t.connection.connect({ path: t.path }), !!this.connection.writable
                );
            }),
        ...
        function(t, e, n) {
            ...
            (r.toPayload = function(t, e) {
                return (
                    ...
                    r.messageId++, { jsonrpc: "2.0", id: r.messageId, method: t, params: e || [] }
                );
            }),
    ...
    44: [
        function(t, e, n) {
            ...
            (o.prototype.buildAsyncGet = function() {
                var t = this,
                    e = function(e) {
                        t.requestManager.sendAsync({ method: t.getter },
                            function(n, r) {
                        ...
                        var m = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
                            y = (o.AES = r.extend({
                                _doReset: function() {
                                    ...
                                    for (
                                        var u = (this._invKeySchedule = []), f = 0; f < o; f++
                                    ) {
                                        var s = o - f;
                                        if (f % 4) var c = a[s];
                                        else var c = a[s - 4];
                    ...
                    (function(t, e) {
                        var n = {},
                            ...
                            s = (a.Hex = {
                                stringify: function(t) {
                                    for (
                                        var e = t.words, n = t.sigBytes, r = [], o = 0; o < n; o++
                                    ) {
                ...
                return (
                    (function() {
                        ...
                        i.Utf16 = i.Utf16BE = {
                            stringify: function(t) {
                                for (
                                    var e = t.words, n = t.sigBytes, r = [], o = 0; o < n; o += 2
                                ) {
                        ...
                        i.Utf16LE = {
                            stringify: function(t) {
                                for (
                                    var n = t.words, r = t.sigBytes, o = [], i = 0; i < r; i += 2
                                ) {
            ...
            !(function(r, o) {
                ...
                return (
                    (function(e) {
                        ...
                        var l = (f.MD5 = u.extend({
                            ...
                            _doProcessBlock: function(t, e) {
                                ...
                                var u = this._hash.words,
                                    ...
                                    O = u[3];
                                (C = n(C, F, I, O, f, 7, p[0])),
                                (O = n(O, C, F, I, l, 12, p[1])),
                                (I = n(I, O, C, F, h, 17, p[2])),
                                (F = n(F, I, O, C, d, 22, p[3])),
                                (C = n(C, F, I, O, m, 7, p[4])),
                                (O = n(O, C, F, I, y, 12, p[5])),
                                (I = n(I, O, C, F, g, 17, p[6])),
                                (F = n(F, I, O, C, v, 22, p[7])),
                                (C = n(C, F, I, O, b, 7, p[8])),
                                (O = n(O, C, F, I, _, 12, p[9])),
                                (I = n(I, O, C, F, w, 17, p[10])),
                                (F = n(F, I, O, C, x, 22, p[11])),
                                (C = n(C, F, I, O, k, 7, p[12])),
                                (O = n(O, C, F, I, B, 12, p[13])),
                                (I = n(I, O, C, F, S, 17, p[14])),
                                (F = n(F, I, O, C, A, 22, p[15])),
                                (C = r(C, F, I, O, l, 5, p[16])),
                                (O = r(O, C, F, I, g, 9, p[17])),
                                (I = r(I, O, C, F, x, 14, p[18])),
                                (F = r(F, I, O, C, f, 20, p[19])),
                                (C = r(C, F, I, O, y, 5, p[20])),
                                (O = r(O, C, F, I, w, 9, p[21])),
                                (I = r(I, O, C, F, A, 14, p[22])),
                                (F = r(F, I, O, C, m, 20, p[23])),
                                (C = r(C, F, I, O, _, 5, p[24])),
                                (O = r(O, C, F, I, S, 9, p[25])),
                                (I = r(I, O, C, F, d, 14, p[26])),
                                (F = r(F, I, O, C, b, 20, p[27])),
                                (C = r(C, F, I, O, B, 5, p[28])),
                                (O = r(O, C, F, I, h, 9, p[29])),
                                (I = r(I, O, C, F, v, 14, p[30])),
                                (F = r(F, I, O, C, k, 20, p[31])),
                                (C = o(C, F, I, O, y, 4, p[32])),
                                (O = o(O, C, F, I, b, 11, p[33])),
                                (I = o(I, O, C, F, x, 16, p[34])),
                                (F = o(F, I, O, C, S, 23, p[35])),
                                (C = o(C, F, I, O, l, 4, p[36])),
                                (O = o(O, C, F, I, m, 11, p[37])),
                                (I = o(I, O, C, F, v, 16, p[38])),
                                (F = o(F, I, O, C, w, 23, p[39])),
                                (C = o(C, F, I, O, B, 4, p[40])),
                                (O = o(O, C, F, I, f, 11, p[41])),
                                (I = o(I, O, C, F, d, 16, p[42])),
                                (F = o(F, I, O, C, g, 23, p[43])),
                                (C = o(C, F, I, O, _, 4, p[44])),
                                (O = o(O, C, F, I, k, 11, p[45])),
                                (I = o(I, O, C, F, A, 16, p[46])),
                                (F = o(F, I, O, C, h, 23, p[47])),
                                (C = i(C, F, I, O, f, 6, p[48])),
                                (O = i(O, C, F, I, v, 10, p[49])),
                                (I = i(I, O, C, F, S, 15, p[50])),
                                (F = i(F, I, O, C, y, 21, p[51])),
                                (C = i(C, F, I, O, k, 6, p[52])),
                                (O = i(O, C, F, I, d, 10, p[53])),
                                (I = i(I, O, C, F, w, 15, p[54])),
                                (F = i(F, I, O, C, l, 21, p[55])),
                                (C = i(C, F, I, O, b, 6, p[56])),
                                (O = i(O, C, F, I, A, 10, p[57])),
                                (I = i(I, O, C, F, g, 15, p[58])),
                                (F = i(F, I, O, C, B, 21, p[59])),
                                (C = i(C, F, I, O, m, 6, p[60])),
                                (O = i(O, C, F, I, x, 10, p[61])),
                                (I = i(I, O, C, F, h, 15, p[62])),
                                (F = i(F, I, O, C, _, 21, p[63])),
                                (u[0] = (u[0] + C) | 0),
                                (u[1] = (u[1] + F) | 0),
                                (u[2] = (u[2] + I) | 0),
                                (u[3] = (u[3] + O) | 0);
                        ...
                        (a.MD5 = u._createHelper(l)),
                        (a.HmacMD5 = u._createHmacHelper(l));
                    })(Math),
                    t.MD5
                );
            });
            ...
            !(function(r, o, i) {
                ...
                return (
                    (t.pad.ZeroPadding = {
                        ...
                        unpad: function(t) {
                            for (
                                var e = t.words, n = t.sigBytes - 1; !((e[n >>> 2] >>> (24 - (n % 4) * 8)) & 255);
                                ...
                                compute: function(t, e) {
                                    for (
                                        var n = this.cfg,
                                            ...
                                            u = a.words,
                                            f = n.keySize,
                                            p = n.iterations; c.length < f;

                                    ) {
                                        var l = r.update(e).finalize(a);
                                        r.reset();
                                        for (
                                            var h = l.words, d = h.length, m = l, y = 1; y < p; y++
                                        ) {
                    ...
                    (function() {
                        ...
                        var n = t,
                            ...
                            u = (i.Rabbit = o.extend({
                                _doReset: function() {
                                    for (
                                        var t = this._key.words, n = this.cfg.iv, r = 0; r < 4; r++
                                    )
                                        t[r] =
            ...
            !(function(r, o, i) {
                ...
                return (
                    (function() {
                        function e() {
                            for (
                                var t = this._S, e = this._i, n = this._j, r = 0, o = 0; o < 4; o++
                            ) {
            ...
            !(function(r, o) {
                ...
                return (
                    (function(e) {
                        ...
                        (c.RIPEMD160 = p._createHelper(b)),
                        (c.HmacRIPEMD160 = p._createHmacHelper(b));
                    })(Math),
                    t.RIPEMD160
                );
            });
                ...
                return (
                    (function(e) {
                        ...
                        var h = (c.SHA3 = i.extend({
                            ...
                            _doProcessBlock: function(t, e) {
                                for (
                                    var n = this._state, r = this.blockSize / 2, o = 0; o < r; o++
                                ) {
                                    var i = t[e + 2 * o],
                                        a = t[e + 2 * o + 1];
                                    (i =
                    ...
                    (function() {
                        ...
                        var p = (c.SHA512 = o.extend({
                            ...
                            _doProcessBlock: function(t, e) {
                                ...
                                (y = o.low = y + D),
                                (o.high = m + N + (y >>> 0 < D >>> 0 ? 1 : 0)),
                                (v = i.low = v + P),
                                (i.high = g + T + (v >>> 0 < P >>> 0 ? 1 : 0)),
                                (_ = a.low = _ + R),
                                (a.high = b + E + (_ >>> 0 < R >>> 0 ? 1 : 0)),
                                (x = s.low = x + H),
                                (s.high = w + M + (x >>> 0 < H >>> 0 ? 1 : 0)),
                                (B = c.low = B + q),
                                (c.high = k + j + (B >>> 0 < q >>> 0 ? 1 : 0)),
                                (A = p.low = A + z),
                                (p.high = S + L + (A >>> 0 < z >>> 0 ? 1 : 0)),
                                (F = l.low = F + W),
                                (l.high = C + U + (F >>> 0 < W >>> 0 ? 1 : 0));
                            },
                            _doFinalize: function() {
                                var t = this._data,
                                    e = t.words,
                        ...
                        (n.SHA512 = o._createHelper(p)),
                        (n.HmacSHA512 = o._createHmacHelper(p));
                    })(),
                    t.SHA512
                );
            });
                    ...
                    (function() {
                        ...
                        var r = t,
                            ...
                            h = (s.DES = a.extend({
                                _doReset: function() {
                                    for (
                                        var t = this._key, e = t.words, n = [], r = 0; r < 56; r++
                                    ) {
                                        var o = c[r] - 1;
                                        n[r] = (e[o >>> 5] >>> (31 - (o % 32))) & 1;
                                    }
                                    for (var i = (this._subKeys = []), a = 0; a < 16; a++) {
                                        for (var s = (i[a] = []), p = f[a], r = 0; r < 24; r++)
                                            (s[(r / 6) | 0] |=
                                                n[(u[r] - 1 + p) % 28] << (31 - (r % 6))),
                                            (s[4 + ((r / 6) | 0)] |=
                                                n[28 + ((u[r + 24] - 1 + p) % 28)] <<
                ...
                return (
                    (function(e) {
                        ...
                        (a.WordArray = o.extend({
                            ...
                            toX32: function() {
                                for (
                                    var t = this.words, e = t.length, n = [], r = 0; r < e; r++
                                ) {
                                    var o = t[r];
        ...
        function(t, e, n) {
            !(function(t) {
                ...
                var m,
                    ...
                    b = { version: "2.1.2", encode: c, decode: p };
                if (
            ...
            !(function(n) {
                ...
                function r(t) {
                    function e(t, r) {
                        ...
                        if (!(f instanceof e))
                            return (
                                W && D(26, "constructor call without new", t), new e(t, r)
                            );
                        if (null != r && J(r, 2, 64, E, "base")) {
                            if (((r = 0 | r), (u = t + ""), 10 == r))
                                return (
                                    (f = new e(t instanceof e ? t : u)), T(f, H + f.e + 1, j)
                                );
                            if (
                            ...
                            s
                                ?
                                ((f.s = 1 / t < 0 ? ((u = u.slice(1)), -1) : 1),
                                    W && u.replace(/^0\.0*|\./, "").length > 15 && D(E, w, t),
                                    (s = !1)) :
                        ...
                        for (
                            (i = u.indexOf(".")) > -1 && (u = u.replace(".", "")),
                            (a = u.search(/e/i)) > 0 ?
                            (i < 0 && (i = a),
                                (i += +u.slice(a + 1)),
                                (u = u.substring(0, a))) :
                            i < 0 && (i = u.length),
                            a = 0; 48 === u.charCodeAt(a); a++
                        );
                        for (c = u.length; 48 === u.charCodeAt(--c););
                        if ((u = u.slice(a, c + 1)))
                            if (
                                ((c = u.length),
                                    s && W && c > 15 && D(E, w, f.s * t),
                                    (i = i - a - 1),
                                    i > U)
                            )
                                f.c = f.e = null;
                            ...
                            if (
                                ...
                                for (a && f.c.push(+u.slice(0, a)), c -= B; a < c;)
                                    f.c.push(+u.slice(a, (a += B)));
                    ...
                    function n(t, n, r, o) {
                        ...
                        for (
                            ...
                            ((c = $),
                                ...
                                (l = d.pow(t.length - m)),
                                ($ = c),
                                (d.c = u(p(i(l.c), l.e), 10, n)),
                                (d.e = d.c.length)),
                            h = u(t, r, n),
                            s = c = h.length; 0 == h[--c]; h.pop()
                        );
                        if (!h[0]) return "0";
                        if (
                            (m < 0 ?
                    ...
                    function h(t, n, r, o) {
                        var a, s, c, u, l;
                        if (((r = null != r && J(r, 0, 8, o, _) ? 0 | r : j), !t.c))
                            return t.toString();
                        if (((a = t.c[0]), (c = t.e), null == n))
                            (l = i(t.c)),
                            (l = 19 == o || (24 == o && c <= q) ? f(l, c) : p(l, c));
                        else if (
                            ((t = T(new e(t), n, r)),
                                (s = t.e),
                                (l = i(t.c)),
                    ...
                    return (
                        ...
                        (e.config = function() {
                            ...
                            return (
                                a((e = "DECIMAL_PLACES")) && J(t, 0, F, 2, e) && (H = 0 | t),
                                (r[e] = H),
                                a((e = "ROUNDING_MODE")) && J(t, 0, 8, 2, e) && (j = 0 | t),
                                (r[e] = j),
                                a((e = "EXPONENTIAL_AT")) &&
                                (c(t) ?
                                    J(t[0], -F, 0, 2, e) &&
                                ...
                                a((e = "CRYPTO")) &&
                                (t === !!t || 1 === t || 0 === t ?
                                    ((G = !(!t || !d || "object" != typeof d)),
                                        t && !G && W && D(2, "crypto unavailable", d)) :
                                    W && D(2, e + b, t)),
                                (r[e] = G),
                                a((e = "MODULO_MODE")) && J(t, 0, 9, 2, e) && (X = 0 | t),
                                (r[e] = X),
                                a((e = "POW_PRECISION")) && J(t, 0, F, 2, e) && ($ = 0 | t),
                                (r[e] = $),
                                a((e = "FORMAT")) &&
                                ("object" == typeof t ?
                                    (V = t) :
                                    W && D(2, e + " not an object", t)),
                                (r[e] = V),
                                r
                            );
                        }),
                        ...
                        (e.random = (function() {
                            ...
                            return function(t) {
                                var r,
                                    ...
                                    f = new e(M);
                                if (
                                    ((t = null != t && J(t, 0, F, 14) ? 0 | t : H),
                                        (a = g(t / B)),
                                        G)
                                )
                                    if (d && d.getRandomValues) {
                                        for (
                                            r = d.getRandomValues(new Uint32Array((a *= 2))); c < a;

                                        )
                                            (s = 131072 * r[c] + (r[c + 1] >>> 11)),
                                            s >= 9e15 ?
                                            ((o = d.getRandomValues(new Uint32Array(2))),
                                                (r[c] = o[0]),
                                                (r[c + 1] = o[1])) :
                                            (u.push(s % 1e14), (c += 2));
                                        c = a / 2;
                                    } else if (d && d.randomBytes) {
                                    for (r = d.randomBytes((a *= 7)); c < a;)
                                        (s =
                                ...
                                for (
                                    a = u[--c],
                                    t %= B,
                                    a && t && ((s = A[B - t]), (u[c] = v(a / s) * s)); 0 === u[c]; u.pop(), c--
                                );
                                if (c < 0) u = [(i = 0)];
                                else {
                        ...
                        (P = (function() {
                            ...
                            return function(i, a, s, c, u) {
                                ...
                                if ((D[l] > (N[l] || 0) && p--, O < 0)) b.push(1), (h = !0);
                                else {
                                    for (
                                        A = N.length,
                                        F = D.length,
                                    ...
                                    do {
                                        if (((d = 0), (f = n(D, _, F, w)), f < 0)) {
                                            ...
                                            if (
                                                ...
                                                for (; n(D, _, F, w) < 1;)
                                                    d++, r(_, F < w ? I : D, w, u), (w = _.length);
                                        } else 0 === f && (d++, (_ = [0]));
                                        (b[l++] = d),
                                        _[0] ? (_[w++] = N[S] || 0) : ((_ = [N[S]]), (w = 1));
                                ...
                                if (o.test(p)) a.s = isNaN(p) ? null : p < 0 ? -1 : 1;
                                    ...
                                    if (!c &&
                                        ((p = p.replace(t, function(t, e, n) {
                                            ...
                                            u &&
                                            ((f = u), (p = p.replace(n, "$1").replace(r, "0.$1"))),
                                            s != p)
                                    )
                                        return new e(p, f);
                                    W && D(E, "not a" + (u ? " base " + u : "") + " number", s),
                                        (a.s = null);
                                }
                                (a.c = a.e = null), (E = 0);
                            };
                        ...
                        (R.decimalPlaces = R.dp =
                            function() {
                                ...
                                if (!n) return null;
                                if (
                                    ((t = ((e = n.length - 1) - o(this.e / B)) * B), (e = n[e]))
                                )
                                    for (; e % 10 == 0; e /= 10, t--);
                                return t < 0 && (t = 0), t;
                            }),
                        ...
                        (R.minus = R.sub =
                            function(t, n) {
                                ...
                                if (!f || !p) {
                                    if (!l || !h)
                                        return l ? ((t.s = -n), t) : new e(h ? c : NaN);
                                    if (!l[0] || !h[0])
                                        return h[0] ?
                                            ((t.s = -n), t) :
                                            new e(l[0] ? c : 3 == j ? -0 : 0);
                                ...
                                if (
                                    (s && ((a = l), (l = h), (h = a), (t.s = -t.s)),
                                        (n = (i = h.length) - (r = l.length)),
                                        n > 0)
                                )
                                    for (; n--; l[r++] = 0);
                                for (n = k - 1; i > u;) {
                        ...
                        (R.plus = R.add =
                            function(t, n) {
                                ...
                                for (
                                    a = u.length,
                                    n = f.length,
                                    a - n < 0 && ((r = f), (f = u), (u = r), (n = a)),
                                    a = 0; n;

                                )
                                    (a = ((u[--n] = u[n] + f[n] + a) / k) | 0), (u[n] %= k);
                            ...
                            function(t) {
                                ...
                                if (
                                    (null != t &&
                                        ...
                                        1 !== t &&
                                        0 !== t &&
                                        (W && D(13, "argument" + b, t), t != !!t && (t = null)), !o)
                                )
                                    return null;
                            ...
                            function() {
                                ...
                                if (
                                    ...
                                    for (p = r.e, f = p + l, f < 3 && (f = 0);;)
                                        if (
                                            ((s = r),
                                                (r = h.times(s.plus(P(c, s, l, 1)))),
                                                i(s.c).slice(0, f) === (n = i(r.c)).slice(0, f))
                                        ) {
                                            if (
                                                (r.e < p && --f,
                                                    (n = n.slice(f - 3, f + 1)),
                                                ...
                                                (T(r, r.e + H + 2, 1), (t = !r.times(r).eq(c)));
                                                break;
                                            }
                        ...
                        (R.times = R.mul =
                            function(t, n) {
                                ...
                                if (!(_ && w && _[0] && w[0]))
                                    return (!b.s || !t.s || (_ && !_[0] && !w) || (w && !w[0] && !_) ?
                                        (t.c = t.e = t.s = null) :
                                        ((t.s *= b.s),
                                            _ && w ?
                                            ((t.c = [0]), (t.e = 0)) :
                                ...
                                for (
                                    ...
                                    h = w.length,
                                    f < h &&
                                    ((y = _), (_ = w), (w = y), (a = f), (f = h), (h = a)),
                                    a = f + h,
                                    y = []; a--; y.push(0)
                                );
                                for (g = k, v = C, a = h; --a >= 0;) {
                                    for (
                                        r = 0, d = w[a] % v, m = (w[a] / v) | 0, c = f, s = a + c; s > a;
                        ...
                        (R.toDigits = function(t, n) {
                            var r = new e(this);
                            return (
                                (t = null != t && J(t, 1, F, 18, "precision") ? 0 | t : null),
                                (n = null != n && J(n, 0, 8, 18, _) ? 0 | n : j),
                                t ? T(r, t, n) : r
                            );
                        }),
                        ...
                        (R.toFixed = function(t, e) {
                            return h(
                                this,
                                null != t && J(t, 0, F, 20) ? ~~t + this.e + 1 : null,
                                e,
                                20
                            );
                        }),
                        (R.toFormat = function(t, e) {
                            var n = h(
                                this,
                                null != t && J(t, 0, F, 21) ? ~~t + this.e + 1 : null,
                                e,
                                21
                            );
                            if (this.c) {
                                var r,
                                    ...
                                    l = p.length;
                                if (
                                    (a && ((r = i), (i = a), (a = r), (l -= r)), i > 0 && l > 0)
                                ) {
                                    for (r = l % i || i, c = p.substr(0, r); r < l; r += i)
                                        c += s + p.substr(r, i);
                                ...
                                (null != t &&
                                    ((W = !1),
                                        ...
                                        (W &&
                                            ...
                                            (t = !l && c.c && T(c, c.e + 1, 1).gte(M) ? c : null))), !d)
                            )
                                return h.toString();
                            for (
                                p = i(d),
                                a = m.e = p.length - h.e - 1,
                                m.c[0] = A[(s = a % B) < 0 ? B + s : s],
                                t = !t || c.cmp(m) > 0 ? (a > 0 ? m : y) : c,
                                s = U,
                                U = 1 / 0,
                                c = new e(p),
                                u.c[0] = 0;
                                (f = P(c, m, 0, 1)), (o = r.plus(f.times(g))), 1 != o.cmp(t);

                            )
                                (r = g),
                                (g = o),
                                (y = u.plus(f.times((o = y)))),
                                (u = o),
                                (m = c.minus(f.times((o = m)))),
                                (c = o);
                            return (
                                (o = P(t.minus(r), g, 0, 1)),
                                (u = u.plus(o.times(y))),
                        ...
                        (R.toPrecision = function(t, e) {
                            return h(
                                this,
                                null != t && J(t, 1, F, 24, "precision") ? 0 | t : null,
                                e,
                                24
                            );
                        }),
                ...
                function u(t, e, n) {
                    for (var r, o, i = [0], a = 0, s = t.length; a < s;) {
                        ...
                        for (i[(r = 0)] += x.indexOf(t.charAt(a++)); r < i.length; r++)
                            i[r] > n - 1 &&
                            (null == i[r + 1] && (i[r + 1] = 0),
                                (i[r + 1] += (i[r] / n) | 0),
                                (i[r] %= n));
                ...
                var h,
                    ...
                    C = 1e7,
                    F = 1e9;
                if (((h = r()), "function" == typeof define && define.amd))
                    define(function() {
                        return h;
                    });
